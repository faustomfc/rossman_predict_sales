...
class Rossman(object):
    def __init__(self):
        self.home_path='/home/fausto/repos/rossman/rossman_predict_sales/'
    ...
    def feature_engineering(self, df2):
        ...
        df3 = df3.drop(['open', 'promo_interval', 'month_map', 'id'], axis=1)
    ...
    def get_prediction(self, model, origin_data, test_data):
        # prediction
